...
public class TinyDB {
    ...
    public ArrayList<AppCard> getAppCardListObject(String key, Class<?> mClass) {
        Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<AppCard> objects = new ArrayList<AppCard>();

        for (String jObjString : objStrings) {
            Object value = gson.fromJson(jObjString, mClass);
            // Log.d("SharedPreference", "objArray obj " + value);

            objects.add((AppCard) value);
        }
        return objects;
    }
...
//
    ...
    public void putAppCardList(String key, ArrayList<AppCard> objArray) {
        checkForNullKey(key);
        Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (AppCard obj : objArray) {
            // Log.d("SharedPreference","putlist obj "+gson.toJson(obj));
            // Log.d("SharedPreference", "put card obj " + obj.getTitle());
